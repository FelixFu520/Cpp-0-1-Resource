...
​	**序列式容器**:强调值的排序，序列式容器中的每个元素均有固定的位置。（1，4，3，2，5）
...
![image-20201116142619119](assets/image-20201116142619119.png)
...
void test01()
{
	...
	//第四种插入方式，不建议，因为写个value不存在的数会造成，m[5]=0,
	m[4] = 40; 
	printMap(m);
